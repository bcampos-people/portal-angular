...
(function($, document){
    ...
    $.fn.scrollbar.defaults = {
        ...
        handleHeight        : 53, // height of handle [Number in px || 'auto']. If set to 'auto', the height will be calculated proportionally to the container-content height.
        ...
        scrollStep          : 40,     // increment of handle position between two mousedowns on arrows [Number in px].
